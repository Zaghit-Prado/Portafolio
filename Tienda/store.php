...
">
	...
	<div class="container">
		...
		<div class="row">
			...
			global $prod;
			$prod = $_GET['prod'];
			$sql = "SELECT * FROM `Productos` where `categoria` LIKE '$prod';";
			...
			<div class="col-md-12">
				<ul class="breadcrumb-tree">
					...
					<li class="active"><?php echo utf8_encode($producto['categoria']) ?></li>
					<li class="active"></li>
	...
	<!-- /container -->
		...
		<div class="container">
			...
			<?php
					global $prod;
					$prod = $_GET['prod'];
					$consulta = $conn->query("SELECT * FROM `Productos` where `categoria` LIKE '$prod';");
